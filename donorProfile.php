...
<head>
	...
	<script>
	function myFunction(){
		window.open("donorProfilePrint.php");
	}
	</script>
</head>
<body>
<div id ="wrapper">
	...
	<div id="middlerecord" class="scroll">
		...
		<?php
				...
				echo "<table border='1'>";
				echo "<tr><th>Name</th><th>Address</th><th>Contact</th><th>Company</th></tr>";
				for($i=0; $i < $rows; $i++){
					echo "<td><p>";
					...
					echo "</p></td><td><p>";
					echo "<a href='editdonor.php? id=";
					echo mysql_result($r, $i, 'id');
					echo "'>Edit</a>";
					echo "</p></td><td><p>";
					echo "<a href='deletedonor.php? id=";
					echo mysql_result($r, $i, 'id');
					echo "'>Delete</a>";
					echo "</p></td></tr>";
				}
