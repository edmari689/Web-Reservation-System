...
<div id="wrapper">
	...
	<fieldset style="text-align:left; margin: left; -moz-border-radius: 15px; border-radius: 15px; border:solid 2px black;" class="donation">
		<legend> Update Donor Form </legend> 
		<form name="updatedonor" action="updatedonor.php"> 	
		<div id="middlerecord" class="scroll" style="float:center;">
			<?php
				...
				echo "<table border='0'>";
				echo "<tr><th>Name of Donor</th><th>Address</th><th>Contact</th><th>Company</th></tr>";
				for($i=0; $i < $rows; $i++){
					echo "<td><input type='text' name='name' id='name' value='";
					echo mysql_result($r, $i, 'name');
					echo "'></td><td><input type='text' name='address' id='address' value='";
					echo mysql_result($r, $i, 'address');
					echo "'></td><td><input type='text' name='contact' id='contact' value='";
					echo mysql_result($r, $i, 'contact');
					echo "'></td><td><input type='text' name='company' id='company' value='";
					echo mysql_result($r, $i, 'company');
					echo "'></td><td>";
