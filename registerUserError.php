<html>
			...
			function validateForm(form)
			{
				...
				var sex = document.getElementById("sex").value;
					...
					if (form.pass.value.length < 6) {
						...
						alert("Please wait for your confirmation email that will be sent by the administrator to validate your information. Thank you!");
				}
			}
		</script>
    </head>
	<body background="skybird.jpg">
		...
		<form name="addRegistration" action="addRegistration.php" onsubmit="return validateForm(this)" method = "post">
			<table class="t1" border="0" style="width:500px;">
				...
				<tr>
					<td>						
						...
						<input type="text" name="user" id="user"style="width: 260px;"><p style="color:red;">Username already exists!</p>	
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>			
						<input type = "submit" value="Create my account" style="width:260px; background-color: #347C2C; color: #FFFFFF; font-family: calibri; font-size: 130%" /><br>
