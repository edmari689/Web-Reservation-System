...
<div id="wrapper">
	...
	<fieldset style="text-align:left; margin: left; -moz-border-radius: 15px; border-radius: 15px; border:solid 2px black;" class="donation">
		<legend> Update Reservation Form </legend> 
		<form name="updatereservation" action="updatereservation.php"> 	
		<div id="middlerecord" class="scroll" style="float:center;">
			<?php
				...
				for($i=0; $i < $rows; $i++){
					...
					echo "'>";
					?>
					<a href="javascript:NewCal('checkinDate','yyyymmdd',24)">
					<img src="dateCalendar.jpg" width="16" height="16" border="0" alt="Pick a date">
					</a>
					<?php
					echo "</td><td><input type='text' name='checkoutDate' id='checkoutDate' value='";
					echo mysql_result($r, $i, 'checkout_date');
					echo "'>";
					?>
					<a href="javascript:NewCal('checkoutDate','yyyymmdd',24)">
					<img src="dateCalendar.jpg" width="16" height="16" border="0" alt="Pick a date">
					</a>
					<?php
					echo "</td><td><input type='text' name='guest' id='guest' value='";
					echo mysql_result($r, $i, 'guest');
					echo "'></td><td><select name = 'type' id = 'type'><option value = '";
					echo mysql_result($r, $i, 'type');
					echo "'>";
					echo mysql_result($r, $i, 'type');
					echo "</option><option value = 'Recollection'>Recollection</option><option value = 'Retreat'>Retreat</option></select>";
					echo "</td><td>";
