...
<div id="wrapper">
	...
	<fieldset style="text-align:left; margin: left; -moz-border-radius: 15px; border-radius: 15px; border:solid 2px black;" class="donation">
		...
		<form name="editroomdetails" action="editroomdetails.php"> 	
		<div id="middlerecord" class="scroll" style="float:center;">
			<?php
				...
				echo "<table border='0'>";
				echo "<tr><th>Room Number</th><th>Capacity</th><th>Status</th></tr>";
				for($i=0; $i < $rows; $i++){
					echo "<td><input type='text' name='room_no' id='room_no' readonly value='";
					echo mysql_result($r, $i, 'room_no');
					echo "'></td><td><input type='text' name='capacity' id='capacity' value='";
					echo mysql_result($r, $i, 'capacity');
					echo "'></td><td><select name = 'status' id = 'status'>";
