		...
		<div id="middlerecord" class="scroll" style="float:center;">
			<?php
				...
				for($i=0; $i < $rows; $i++){
					...
					echo "' readonly></td><td><input type='text' name='room_no' id='room_no' value='";
					echo mysql_result($r, $i, 'guest_room_usage.room_no');
					echo "' readonly></td>";
					echo "</tr>";
					echo "</table>";
					
					echo "<td><input type='hidden' name='guest_no' id='guest_no' value='";
					echo mysql_result($r, $i, 'guest_room_usage.guest_no');
					echo "' readonly></td>";
				}
				mysql_close($db);
			?>	
			<h4>Are you sure want to check-out?</h4>
			<table align="left">
