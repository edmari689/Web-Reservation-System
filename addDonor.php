...
<div id="wrapper">
	...
	<fieldset style="float:left; width: auto">
		<legend style="background-color: #faafba">  Donor Form </legend>
	<form name="add_donation" action="add_donation.php">		
		<table>
			<tr>
				<td> Donor </td> <td><input type = 'text' name ='name' id ='name'></td>
			</tr>
			<tr>
			...
			<tr>
				<td><button type = "submit" style="background-color: #41A317; color: #FEFCFF"> ADD DONOR </button> </td>
