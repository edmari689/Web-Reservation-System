...
<div id="wrapper">
	...
	<br/>
	<fieldset style="text-align:left; margin: left; -moz-border-radius: 15px; border-radius: 15px; border:solid 2px black; width: 200px;" class="donation">
		<form name="allOut" action="allOut.php" method = "POST"> 	
		<div id="middlerecord" class="scroll" style="float:center;">
			<h4>Are you sure you want to check out all guests?</h4>
			<table align="left">
