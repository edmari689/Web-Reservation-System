	...
	<fieldset style="text-align:left; margin: left; -moz-border-radius: 15px; border-radius: 15px; border:solid 2px black;" class="donation">
		...
		<div id="middlerecord" class="scroll" style="float:center;">
			...
			<?php
				...
				$query = "SELECT * FROM guest ORDER BY guest.id ASC";
				$r = mysql_query($query);
				...
				for($i=0; $i < $rows; $i++){
					...
					echo "</p></td><td><p>";
					echo mysql_result($r, $i, 'guest.address');
					echo "</p></td><td><p>";
					echo mysql_result($r, $i, 'guest.sex');
					echo "</p></td><td><p>";
					echo "<a href='editguest.php? id=";
					echo mysql_result($r, $i, 'id');
					echo "'>Edit</a>";
					echo "&nbsp&nbsp";
					echo "<a href='deleteguest.php? id=";
					echo mysql_result($r, $i, 'id');
					echo "'>Delete</a>";
					echo "</p></td></tr>";
				}
