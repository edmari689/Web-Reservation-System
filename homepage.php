...
<body>
        ...
        <div class="body" style="background-color: #FEFCFF; height: 425px; margin: auto; width: 70%">
            ...
            <img src="bodyPhoto.png"/> <h2 class="about"> About Us </h2>
            <p>
                In a one small community in Cat. Grande, Sacred Hearts Spirituality Centre runs the place. <br/>
                The Sacred Heart mission is to bring peace and make each retreatants feel the enlightenment.<br/>

            </p>
            <h2 class="contact"> Contact Us </h2>
            <p class="call">
                Pink St., Catalunan Grande, Davao City, 8000 <br/>
                Tel. No. 298 - 0347
            </p>
        </div>   
