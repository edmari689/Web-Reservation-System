...
<div id="wrapper">
	...
	<?php
			...
			if($person == "Student")
			{
				...
				echo "<legend>Reservation Form: Step 3</legend>";
				echo "<p><b><center>Choose a Package</center></b></p>";
				echo "<hr></hr>";
				echo "<form name='addReservationAdmin' action='addReservationAdmin.php' method = 'post'>";
				
				$query="SELECT * FROM recollection_package where guest_type = 'Student' and status != 'Unavailable'";
				$result = mysql_query($query);
				
				echo "<table>";
				echo "<tr>";
				echo "<td>Recollection Student Rates W/ Amount</td>";
				echo "<td><select name='recollection_id' id = 'recollection_id' value=''>
				<option value=''></option>";
			...
			else
			{
				...
				$query="SELECT * FROM recollection_package where guest_type = 'Regular' and status != 'Unavailable'";
				$result = mysql_query($query);
				
				echo "<table>";
				echo "<tr>";
				echo "<td>Recollection Regular Rates W/ Amount</td>";
				echo "<td><select name='recollection_id' id = 'recollection_id' value=''>
				<option value=''></option>";
				while($nt=mysql_fetch_array($result))
				{
