<html>
	...
	<body background = "rosecheek.jpg">
		...
		else
		{
			...
			//$x++;
			//if($x==1)
			$construct .="id LIKE '%$search_each%' OR checkin_date LIKE '%$search_each%' OR type LIKE '%$search_each%' OR status LIKE '%$search_each%' OR client_id LIKE '%$search_each%'";
			//else
			...
			else
			{
				...
				echo "<table border='1'>";
				echo "<tr><th>Reservation ID</th><th>Name</th><th>Check-In Date</th><th>Check-Out Date</th><th>Guests</th><th>Type of Reservation</th></tr>";
