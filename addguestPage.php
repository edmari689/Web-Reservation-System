...
<div id="wrapper">
	...
	<legend> Guest Form </legend>
		<form name="addguest" action="addguest.php"> 		
		...
		<tr>
			...
			<tr>
				<td> Guest's Name </td> <td> <input type = 'text' name ='name' id ='name'></td>
			</tr>
			<tr>
		...
		<table align="center">
			<td><button type = "submit" style="background-color: #41A317; color: #FEFCFF" >Add Guest </button></td>
