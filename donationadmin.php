...
<head>
	...
	<script>
	function myFunction(){
		window.open("donationadminPrint.php");
	}
	</script>
</head>
<body>
<div id="wrapper">
	...
	<button onclick="myFunction()">Print this page</button>
		<form action='searchdonation.php' method='GET'>
		...
		<fieldset style="width: 900px; background-color: #f0f8ff">
		<legend style="background-color: #659ec7"> Money Donation Details </legend> 
		<div id="middlerecord" class="scroll">
			<?php
				...
				for($i=0; $i < $rows; $i++){
					...
					echo "</p></td><td><p>";
					echo "<a href='editdonation.php? id=";
		...
		<br/>
		<fieldset style="width: 900px; background-color: #c3fdb8">
		<legend style="background-color: #6cbb3c"> In-Kind Donation Details </legend> 	
		<div id="middlerecord" class="scroll">
			<?php
				$db = mysql_connect('localhost','root','root');
				mysql_select_db('sacredheart');
