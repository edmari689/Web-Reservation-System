...
<div id="wrapper">
	...
	<fieldset style="text-align:left; margin: left; -moz-border-radius: 15px; border-radius: 15px; border:solid 2px black;" class="donation">
		<legend> Update Payment Form </legend> 
		<form name="updatepayment" action="updatepayment.php"> 	
		<div id="middlerecord" class="scroll" style="float:center;">
			<?php
				...
				echo "<table border='0'>";
				echo "<tr><th>Confirm ID</th><th>Amount</th><th>Type of Person</th><th>Type of Event</th></tr><tr>";
				for($i=0; $i < $rows; $i++){
					echo "<td><input type='text' name='confirm_id' id='confirm_id' value='";
					echo mysql_result($r, $i, 'confirm_id');
					echo "'></td><td><input type='text' name='amount' id='amount' value='";
					echo mysql_result($r, $i, 'amount');
					echo "'></td><td><input type='text' name='type_person' id='type_person' value='";
					echo mysql_result($r, $i, 'type_person');
					echo "'></td><td><input type='text' name='type_event' id='type_event' value='";
					echo mysql_result($r, $i, 'type_event');
					echo "'></td><td>";
